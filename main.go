...
import (
	"log"
	"net/http"
	"tutr-backend/controller/attendance"
	controller "tutr-backend/controller/auth"
	doubtchats "tutr-backend/controller/doubt_chats"
	"tutr-backend/controller/emails"
	p "tutr-backend/controller/profile_data"
	s "tutr-backend/controller/student"
	t "tutr-backend/controller/teachers"
	tan "tutr-backend/controller/teachers/add_notes"
	tg "tutr-backend/controller/teachers/create_group"
	tn "tutr-backend/controller/teachers/notice_board"
