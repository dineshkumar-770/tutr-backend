...
type GroupNotes struct {
	...
	FileURLsList     []NotesURLFiles `json:"attached_files,omitempty"`
...
type NotesURLFiles struct {
	NotesFileName string `json:"file_name,omitempty"`
	NotesFileURL string `json:"note_url,omitempty"`
}
